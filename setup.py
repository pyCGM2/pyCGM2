...
setup(name = 'pyCGM2',
    ...
    entry_points={
          'console_scripts': [
                ...
                'Nexus_plot_normalizedKinetics       =  pyCGM2.Apps.ViconApps.Plot.plotNormalizedKinetics:main',
                'Nexus_plot_spatioTemporalParameters =  pyCGM2.Apps.ViconApps.Plot.plotSpatioTemporalParameters:main',
                'Nexus_plot_temporalKinematics       =  pyCGM2.Apps.ViconApps.Plot.plotTemporalKinematics:main',
                'Nexus_plot_temporalKinetics         =  pyCGM2.Apps.ViconApps.Plot.plotTemporalKinetics:main',
                'Nexus_plot_comparison_normalizedKinematics     =  pyCGM2.Apps.ViconApps.Plot.plotCompareNormalizedKinematics:main',
                'Nexus_plot_comparison_normalizedKinetics     =  pyCGM2.Apps.ViconApps.Plot.plotCompareNormalizedKinetics:main',
                'Nexus_plot_normalizedEmg = pyCGM2.Apps.ViconApps.Plot.plotNormalizedEmg:main',
                'Nexus_plot_temporalEmg   = pyCGM2.Apps.ViconApps.Plot.plotTemporalEmg:main',
                'Nexus_plot_comparison_normalizedEmg = pyCGM2.Apps.ViconApps.Plot.plotCompareNormalizedEmg:main',
