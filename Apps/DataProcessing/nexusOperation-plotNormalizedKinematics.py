...
if __name__ == "__main__":
    ...
    if NEXUS_PYTHON_CONNECTED:
        ...
        if not consistencyFlag:
            plot.plot_DescriptiveKinematic(DATA_PATH,analysis,nds,exportPdf=True,outputName=modelledFilename)
        else:
            plot.plot_ConsistencyKinematic(DATA_PATH,analysis,nds,exportPdf=True,outputName=modelledFilename)
