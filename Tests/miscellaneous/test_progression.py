...
if __name__ == "__main__":
    ...
    OpenmaProgressionTest.gaitTrialProgressionX_forward_lateralY()
    OpenmaProgressionTest.gaitTrialProgressionX_backward_lateralY()
    OpenmaProgressionTest.gaitTrialProgressionY_forward_lateralX()
    OpenmaProgressionTest.gaitTrialProgressionY_backward_lateralX()
