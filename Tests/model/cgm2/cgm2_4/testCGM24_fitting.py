...
class CGM2_4_Tests():
    ...
    def noIK_determinist(cls):
        ...
        btkTools.smartWriter(acqGait,"cgm24_noIKdeterminist_Motion.c3d")
    ...
    def noIK_6dof(cls):
        ...
        btkTools.smartWriter(acqGait,"cgm24_noIK6dof_Motion.c3d")
    ...
    def full_IK(cls):
        ...
        btkTools.smartWriter(acqIK,"cgm24_fullIK_Motion.c3d")
