...
class CGM2_3_staticFitting():

    @classmethod
    def noIK_determinist(cls):
        MAIN_PATH = pyCGM2.CONFIG.TEST_DATA_PATH + "CGM2\\cgm2.3\\fullBody\\"
        ...
        btkTools.smartWriter(acqGait,"cgm23_noIKdeterminist_staticMotion.c3d")
    ...
    def noIK_6dof(cls):
        ...
        btkTools.smartWriter(acqGait,"cgm23_noIK6dof_staticMotion.c3d")
    ...
    def full_IK(cls):
        ...
        btkTools.smartWriter(acqIK,"cgm23_fullIK_staticMotion.c3d")

if __name__ == "__main__":

    #CGM2_3_staticFitting.noIK_determinist()
    CGM2_3_staticFitting.noIK_6dof()
    #CGM2_3_staticFitting.full_IK()
