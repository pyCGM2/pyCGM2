...
# pytest -s --disable-pytest-warnings  test_concreteScenario.py::TestDifferentStaticDynamicmarkerSet::test_CGM1_FullBody_noOptions
"""
...
class TestDifferentStaticDynamicmarkerSet:
    def test_CGM1_FullBody_noOptions(self):
