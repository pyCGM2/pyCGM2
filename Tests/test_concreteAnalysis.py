...
# pytest -s --disable-pytest-warnings  test_concreteAnalysis.py::Test_compare2TestingEMG::test_onlyAnalogsInAcq_withoutFsBoundaries
...
class Test_compare2TestingEMG():
    ...
    def test_onlyAnalogsInAcq_withoutFsBoundaries(self):

        DATA_PATH = pyCGM2.TEST_DATA_PATH+"LowLevel\\c3OnlyAnalog\\gait\\"

        EMG_LABELS,EMG_MUSCLES,EMG_CONTEXT,NORMAL_ACTIVITIES = configuration.getEmgConfiguration(None, None)
        emgTrials_pre = ["20191120-CN-PRE-Testing-NNNS-dyn 09_withoutFSboundaries.c3d"]
        emgTrials_post = ["20191120-CN-POST-testing-NNNNS-dyn 20_withoutFSBoundaries.c3d"]
