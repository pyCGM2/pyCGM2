...
class Test_Scaling:
    def test_cgm23(self):
        ...
        osf = opensimFilters.opensimScalingFilter(DATA_PATH,osimfile,markersetFile,scaleToolFile,statictrc,required_mp)
        ...
        ax1.plot(acqIK1.GetPoint("LAnkleAngles_ik1").GetValues()[:,0],"-r")
        ax1.plot(acqIK2.GetPoint("LAnkleAngles_ik2").GetValues()[:,0],"-ob")

        ax2.plot(acqIK1.GetPoint("LAnkleAngles_ik1").GetValues()[:,1],"-r")
        ax2.plot(acqIK2.GetPoint("LAnkleAngles_ik2").GetValues()[:,1],"-ob")

        ax3.plot(acqIK1.GetPoint("LAnkleAngles_ik1").GetValues()[:,2],"-r")
        ax3.plot(acqIK2.GetPoint("LAnkleAngles_ik2").GetValues()[:,2],"-ob")

        plt.show()

class Test_InverseDynamics:
    def test_cgm23(self):
        ...
        statictrc = "C:/Users/fleboeuf/Documents/DATA/pyCGM2-Data-Tests/OpenSim/CGM23/gait/staticVerif.trc"  #DATA_PATH + "staticVerif.trc"

        osf = opensimFilters.opensimScalingFilter(DATA_PATH,osimfile,markersetFile,scaleToolFile,statictrc,required_mp)
        scaledOsim = osf.getScaledModel()
        ...
        osrf2 = opensimFilters.opensimFittingFilter(iksetupFile,
                                                          ...
                                                          DATA_PATH,
                                                          acqGait )
        osrf2.exportXml("IkTools_setup.xml", path = DATA_PATH)
        acqIK2 = osrf2.run(str(DATA_PATH + gaitFilename ),exportSetUp=False)

        # # IDEA:
        opensimTools.createGroundReactionForceMOT_file(DATA_PATH,gaitFilename)
        idToolFile = "C:/Users/fleboeuf/Documents/Programmation/pyCGM2/pyCGM2/pyCGM2/Settings/opensim/models/cgm2-msk/CGM23_id_setup.xml"
        ExternalLoads = "C:/Users/fleboeuf/Documents/Programmation/pyCGM2/pyCGM2/pyCGM2/Settings/opensim/models/cgm2-msk/walk_grf.xml"


        # mot_files = ["gait1.mot"]
        # opensimFilters.opensimInverseDynamicsFilter(DATA_PATH,scaledOsim,idToolFile,mot_files)
