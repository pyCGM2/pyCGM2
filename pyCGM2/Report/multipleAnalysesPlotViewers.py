...
class multiAnalyses_LowerLimbKinematicsPlotViewer(plotViewers.AbstractPlotViewer):
    """
    ...
    """
        ...
        super(multiAnalyses_LowerLimbKinematicsPlotViewer, self).__init__(iAnalyses)
...
class multiAnalyses_LowerLimbKineticsPlotViewer(plotViewers.AbstractPlotViewer):
    """
    ...
    """
        ...
        super(multiAnalyses_LowerLimbKineticsPlotViewer, self).__init__(iAnalyses)
