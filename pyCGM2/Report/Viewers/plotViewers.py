...
class NormalizedGroundReactionForcePlotViewer(AbstractPlotViewer):
    ...
    def __setLayer(self):
        ...
        ax0 = plt.subplot(3,3,1)# Hip X extensor
        ax1 = plt.subplot(3,3,2)# Hip Y abductor
        ax2 = plt.subplot(3,3,3)# Hip Z rotation
        ...
        for ax in [self.fig.axes[0],self.fig.axes[1],self.fig.axes[2]]:
            ...
            ax0.set_title("Longitudinal force" ,size=8)
            ax1.set_title("Lateral Force" ,size=8)
            ax2.set_title("Vertical Force" ,size=8)
