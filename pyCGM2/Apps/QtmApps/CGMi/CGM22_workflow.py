...
def command():
    """ run the CGM2.2 workflow with the parameters of the Qtm-generated file session.xml
    ...
    ```bash
        python -m pyCGM2.Apps.QtmApps.CGMi.CGM22_workflow.command
        python -m pyCGM2.Apps.QtmApps.CGMi.CGM22_workflow.command --sessionFile "my session.xml"
    ```

    Args:
        [--sessionFile] (str) : name of your session file generated by QTM (default : "sesssion.xml")
