...
def main():
    ...
    ```bash
        nexus_CGM25_Calibration.exe -l  1 --md 24 -ps "withSuffix"
        nexus_CGM25_Calibration.exe --leftFlatFoot  1 --markerDiameter 24 --pointSuffix "withSuffix"
        nexus_CGM25_Calibration.exe --forceLHJC 0.3 0.25 1.2
        nexus_CGM25_Calibration.exe --noIk
    ```
