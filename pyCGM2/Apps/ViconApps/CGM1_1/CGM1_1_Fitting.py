...
def main():
    ...
    ```bash
        python CGM1_1_Fitting.py -fi  100 -fe 150 --md 24 -ps "withSuffix"
        python CGM1_1_Fitting.py --frameInit  100 --frameEnd 150 --markerDiameter 24 --pointSuffix "withSuffix"
    ```
