...
def main():
    ...
    ```bash
        python CGM2_2_Calibration.py -l  1 --md 24 -ps "withSuffix"
        python CGM2_2_Calibration.py --leftFlatFoot  1 --markerDiameter 24 --pointSuffix "withSuffix"
        python CGM2_2_Calibration.py --forceLHJC 0.3 0.25 1.2
        python CGM2_2_Calibration.py --noIk
    ```
