...
def main():
    ...
    ```bash
        nexus_CGM22_Fitting.exe -fi  100 -fe 150 --md 24 -ps "withSuffix"
        nexus_CGM22_Fitting.exe --frameInit  100 --frameEnd 150 --markerDiameter 24 --pointSuffix "withSuffix"
        nexus_CGM22_Fitting.exe --accuracy 1e-5
    ```
