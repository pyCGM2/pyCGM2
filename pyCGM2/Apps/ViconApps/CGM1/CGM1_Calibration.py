...
def main():
    """ run the CGM1 caibration operation from Nexus

    Usage:

    ```bash
        python CGM1_Calibration.py -l  1 --md 24 -ps "withSuffix"
        python CGM1_Calibration.py --leftFlatFoot  1 --markerDiameter 24 --pointSuffix "withSuffix"
    ```
