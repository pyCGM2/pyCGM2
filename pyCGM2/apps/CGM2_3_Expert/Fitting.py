...
if __name__ == "__main__":
    ...
    # --------------------------CHECKING -----------------------------------    
    # check model is the CGM2.3e
    logging.info("loaded model : %s" %(model.version ))
    if model.version != "CGM2.3e":
        raise Exception ("pyCGM2.model file was not calibrated from the CGM2.3e calibration pipeline"%model.version)
    ...
    for trial in motionTrials:
        ...
        validFrames,vff,vlf = btkTools.findValidFrames(acqGait,cgm.CGM2_3LowerLimbs.MARKERS)
