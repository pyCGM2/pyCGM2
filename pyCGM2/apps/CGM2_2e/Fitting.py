...
from pyCGM2.Model.CGM2.coreApps import cgmUtils, cgm2_2e
from pyCGM2.Utils import files

if __name__ == "__main__":
    DEBUG = False

    parser = argparse.ArgumentParser(description='cgm2.2e Fitting')
    ...
    pointSuffix = argsManager.getPointSuffix("cgm2_2e")
    ...
    if model.version != "CGM2.2e":
        raise Exception ("%s-pyCGM2.model file was not calibrated from the CGM2.2e calibration pipeline"%model.version)
